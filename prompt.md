...
Create an HTML study guide for "Zero-Shot Learning" — a topic relevant to the **CGAI exam**. Follow the same structure as `RNN.html`. Use:
...
- infographic image filename: `ZSL.png`  in the images folder
